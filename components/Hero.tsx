...
export function Hero() {
  const [text] = useTypewriter({
    words: ['Incredible', 'Beautiful', 'Magnificent', 'Breathtaking','Exquisite', 'Wonderful', 'Majestic', 'Lovely', 'Fascinating', 'Marvelous', 'Amazing', 'Awesome', 'Fabulous','Sensational', 'Stupendous', 'Unbelievable', 'Unforgettable'],
    loop: 0,
    delaySpeed: 3000,
  })
  const images = [
  ...
  return (
    <ImagesSlider className="md:h-[35rem] xl:h-[45rem] " images={images}>
      <motion.div
        initial={{
          opacity: 0,
          y: -80,
